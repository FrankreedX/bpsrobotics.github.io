...
$questions = array(
	array('1. Procedures to follow before actually using the drill press should include:', 
		array(
			'A. obtaining teacher permission.',
			'B. securing the work piece.',
			'C. wearing proper eye protection.',
			'D. all of the above.'
		),
	1), 
	array('2. Adjustments must be made with the machine at a dead stop except for the variable which must be set with the machine running.', 
		array(
			'A. True',
			'B. False'
		),
	2), 
	array('3. Remove the chuck key immediately after using it.', 
		array(
			'A. True',
			'B. False'
		),
	3), 
	array('4. If a work piece is caught by the drill', 
		array(
			'A. stop it with your hands.',
			'B. adjust the depth gauge.',
			'C. step back and turn off power.',
			'D. lower the table.'
		),
	4), 
	array('5. Large drills turn at slow speeds.',
		array(
			'A. True',
			'B. False'
		),
	5), 
	array('6. Any special operation requires', 
		array(
			'A. special equipment.',
	...
	6), 
	array('7. The drill press table should be locked in place.',
		array(
			'A. True',
			'B. False'
		),
	7), 
	array('8. __________ must be kept away from moving parts.',
		array(
			'A. Hair and hands',
			'B. Loose clothing',
			'C. Jewelry',
	...
	8), 
	array('9. Be sure that the drill bit is sharp.', 
		array(
			'A. True',
			'B. False'
		),
	9), 
	array('10. In order to prevent the drill bit from binding or grabbing:',
		array(
			'A. ease up on the feed pressure when the bit starts to break through the material.',
			'B. insert the chuck key in the chuck.',
			'C. lower the table.',
			'D. any of the above.'
		),
	10), 
	array('11. To remove a burr use', 
		array(
			'A. a large drill.',
			'B. deburring tool.',
			'C. countersink.',
	...
	12), 
	array('13. When finished,', 
		array(
			'A. wait for the bit to come to a dead stop.',
			'B. remove the drill bit and chuck key.',
			'C. clean up the area.',
