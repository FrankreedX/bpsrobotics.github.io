...
$questions = array(
	array('1. The first thing to do before starting to arc weld is', 
		array(
			'A. turn on power.',
			'B. install rod.',
			'C. strike an arc.',
			'D. get permission from the teacher.'
		),
	1), 
	array('2. To protect others in the immediate area always weld', 
		array(
			'A. in the shower room.',
			'B. in the welding booth or protected area (barrier shields).',
			'C. outside in the rain.',
			'D. all the above.'
		),
	2), 
	array('3. Use pliers or similar tool, not gloves, for picking up hot metal.', 
		array(
			'A. True',
			'B. False'
		),
	3), 
	array('4. Turn off the welder if it is necessary to change the position of the work.', 
		array(
			'A. True',
			'B. False'
		),
	4), 
	array('5. Which of the following must be kept away from the welding area?', 
		array(
			'A. hot metal.',
			'B. cold metal.',
			'C. welding electrodes.',
			'D. combustible material and flammable liquids.'
		),
	5), 
	array('6. Under what condition is it dangerous to weld?', 
		array(
			'A. dry, dusty floor.',
			'B. wet floor.',
			'C. cold room.',
			'D. there is never any danger.'
		),
	6), 
	array('7. Which of the following special protective clothing is needed while welding?', 
		array(
			'A. A helmet with at least a number 10 shaded lens.',
			'B. Long sleeve coat.',
			'C. Leather leggings.',
			'D. All of the above.'
		),
	7), 
	array('8. Warn others before you strike the arc.', 
		array(
			'A. True',
			'B. False'
		),
	8), 
	array('9. If you are uncertain about the set-up or any aspect of the operation, you should', 
		array(
	...
	9), 
	array('10. Avoid steam burns when quenching hot metal by keeping exposed skin well away from quenching water.', 
		array(
			'A. True',
			'B. False'
		),
	10), 
	array('11. You are not permitted to weld on fuel tanks, cans or barrels without instructor approval.', 
		array(
			'A. True',
			'B. False'
		),
	11), 
	array('12. Wearing of contact lenses while arc welding is prohibited.', 
		array(
			'A. True',
			'B. False'
		),
	12), 
	array('13. Report any malfunction of a machine to your instructor such as:', 
		array(
			'A. Hot leads.',
			'B. Electric short.',
			'C. Unusual noises.',
	...
	13), 
	array('14. Electrical shock can happen if an arc occurs between', 
		array(
			'A. electrode holder.',
			'B. ground clamp.',
			'C. table.',
