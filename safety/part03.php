...
$questions = array(
	array('1. Teacher permission is required before using the portable drill.', 
		array(
			'A. True',
			'B. False'
		),
	1), 
	array('2. Eye protection must be worn when using the portable drill.', 
		array(
			'A. True',
			'B. False'
		),
	2), 
	array('3. Disconnect the power before changing the bit in a portable drill.', 
		array(
			'A. True',
			'B. False'
		),
	3), 
	array('4. Remove the chuck key immediately after using it.', 
		array(
			'A. True',
			'B. False'
		),
	4), 
	array('5. Make sure that the switch is in the _____ position before plugging the drill in.', 
		array(
			'A. off',
			'B. on'
		),
	...
	6), 
	array('7. Hold the portable drill firmly at all times.', 
		array(
			'A. True',
			'B. False'
		),
	7), 
	array('8. If a work piece is caught by the drill', 
		array(
			'A. stop it with your hands.',
			'B. insert the chuck key immediately.',
			'C. release the trigger switch.',
			'D. all of the above statements are correct.'
		),
	8), 
	array('9. To prevent accidents while using the portable drill, you should', 
		array(
			'A. apply steady, straight pressure on the drill.',
			'B. ease up on the pressure when the drill bit begins to break through the metal.',
			'C. turn off the power and hold the drill until it comes to a dead stop.',
			'D. all of the above.'
		),
	9), 
	array('10. Large drills should turn at slow speeds.', 
		array(
			'A. True',
			'B. False'
		),
