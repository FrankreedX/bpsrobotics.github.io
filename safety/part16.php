...
$questions = array(
	array('1. Dressing the wheel with the diamond point dresser as needed prevents the wheel from', 
		array(
			'A. becoming glazed.',
			'B. becoming loaded.',
			'C. coming off.',
	...
	1), 
	array('2. The machine must be at a dead stop in order to', 
		array(
			'A. make adjustments (other than depth of cut).',
			'B. make measurements.',
			'C. check wheel surface.',
			'D. All of the above are correct.'
		),
	2), 
	array('3. Your instructor needs to check all setups.', 
		array(
			'A. True',
			'B. False'
		),
	3), 
	array('4. Permanent damage to the wheel may result form', 
		array(
			'A. jamming work into wheel.',
			'B. operating wheel above the recommended r.p.m.',
			'C. over-tightening spindle.',
			'D. All of the above.'
		),
	4), 
	array('5. Cracked or damaged wheels are dangerous and must never be used on the surface or tool grinder because', 
		array(
			'A. they may fly apart.',
			'B. they may vibrate excessively and break up.',
			'C. they can only be used to take very light cuts.',
			'D. both A and B above.'
		),
	5),
	array('6. The work piece must be held solidly in or on the chucking device.', 
		array(
			'A. True',
			'B. False'
		),
	6), 
	array('7. It is permissible to lay tools on this machine.', 
		array(
			'A. True',
			'B. False'
		),
	7), 
	array('8. When holding work piece on magnetic chuck, the base should be', 
		array(
			'A. one half the height.',
			'B. as wide as the height.',
			'C. four or more times as wide as the piece is tall.',
			'D. None of the above.',
			'E. both B and C above'
		),
	8), 
	array('9. If you are uncertain about the set-up or any aspect of the operation, you must', 
		array(
	...
	9), 
	array('10. Long hair, loose clothing and jewelry can be the cause of accidents around machinery.', 
		array(
			'A. True',
			'B. False'
		),
	10), 
	array('11. Disengage manual controls before using automatic or power feed.', 
		array(
			'A. True',
			'B. False'
		),
