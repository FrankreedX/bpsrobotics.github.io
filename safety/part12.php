...
$questions = array(
	array('1. The first item of procedure to operate the milling machine is', 
		array(
			'A. secure work piece.',
			'B. set cutting speed.',
			'C. turn on power.',
			'D. obtain teacher permission.'
		),
	1), 
	array('2. Eye protection must be worn when working around the milling machine.', 
		array(
			'A. True',
			'B. False'
		),
	2), 
	array('3. Make adjustments or set-ups only when', 
		array(
			'A. you have permission.',
			'B. you have read and understand safety rules.',
			'C. the machine is at a dead stop.',
			'D. All of the above.'
		),
	3), 
	array('4. Remove spindle wrench immediately after securing bit in collet.', 
		array(
			'A. True',
			'B. False'
		),
	4), 
	array('5. Which of the items below could be used to securely fasten your work piece?', 
		array(
			'A. a vice.',
			'B. Clamps.',
			'C. Indexing head.',
	...
	5), 
	array('6. Milling machine cutters are sharp and must be handled carefully.', 
		array(
			'A. True',
			'B. False'
		),
	6), 
	array('7. When machine is at a dead stop, chips should be remove with',
		array(
			'A. hand.',
			'B. cloth',
			'C. brush',
	...
	7), 
	array('8. After you are finished using the milling machine, you should', 
		array(
			'A. turn off the power.',
			'B. brake the machine to a dead stop.',
			'C. remove cutter.',
			'D. All of the above.'
		),
	8), 
	array('9. Never clean chips away from cutter while machine is running.', 
		array(
			'A. True',
			'B. False'
		),
	9),
	array('10. Keep fingers at least 6" away from the cutter.', 
		array(
			'A. True',
			'B. False'
		),
	10), 
	array('11. Check and set the proper speed, feed, and depth of cut before starting the milling machine.', 
		array(
			'A. True',
			'B. False'
		),
	11),
	array('12. Floor around the milling machine should be kept clean.',
		array(
			'A. True',
			'B. False'
		),
	12), 
	array('13. Chip shield should be between you and the work piece while cutting.', 
		array(
			'A. True',
			'B. False'
		),
	13), 
	array('14. If you are uncertain about the set-up or any aspect of the operation, you should', 
		array(
